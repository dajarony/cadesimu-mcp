...
def three_phase_supply(index: int, x: int, y: int) -> str:
    return f"*{index}*3004#-X#########*0*0*0*0*0*0*0*0*{x}*{y}*0*0*-12*-9*18*3*0*0*0*1*0*0*0"
...
def control_supply(index: int, x: int, y: int) -> str:
    return f"*{index}*3000#-X#########*0*0*0*0*0*0*0*0*{x}*{y}*0*0*-9*-6*3*12*0*3*0*1*0*0*0"


def control_return(index: int, x: int, y: int) -> str:
    return f"*{index}*3001#-X#########*0*0*0*0*0*0*0*0*{x}*{y}*0*0*-9*-6*3*12*0*3*0*1*0*0*0"
